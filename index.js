...
const boardBackground = "#141E46";
const snakeColor = "#C70039";
const snakeBorder = "#FFF5E0";
const foodColor = "#E55604";
const unitSize = 25;
...
function createFood() {
    ...
    foodXCoord = randomFood(0, gameWidth - unitSize);
    foodYCoord = randomFood(0, gameWidth - unitSize);
    console.log(foodXCoord);
    console.log(foodYCoord);
};

function drawFood() {
    gameContext.fillStyle = foodColor;
    gameContext.fillRect(foodXCoord, foodYCoord, unitSize, unitSize);
};
...
function moveSnake() {
    ...
    // if food is eaten
    if (snake[0].x == foodXCoord && snake[0].y == foodYCoord) {
        score += 1;
        scoreText.textContent = score;
        createFood();
    } else {
